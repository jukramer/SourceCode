import numpy as np 
import physics.shape as sh

import math

from physics.shape import ConvexPolygon, Circle, edges
from physics.vec import magnitude, sqr_magnitude, normalized, orthogonal, dot
